...
class Staff(db.Model):
    ...
    def __init__(self,staff_id,prefix,first_name,last_name,middle_name,suffix,email,contact_hp,contact_home,country_code,address_1,address_2,state,city,postal_code,ispilot,isFlightCrew,password,isactive,hourly_rate):
...
def check_user(emails):
    ...
    try:
        ...
        if(records.password == password['password']):
            return jsonify({"result":True,"staff_id":records.staff_id})
        else:
